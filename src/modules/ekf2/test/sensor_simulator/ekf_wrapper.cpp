...
{
	_ekf_params->height_sensor_ref = HeightSensor::GPS;
}

void EkfWrapper::enableGpsHeightFusion()
{
	_ekf_params->gps_ctrl |= GpsCtrl::VPOS;
}
...
{
	_ekf_params->gps_ctrl |= GpsCtrl::HPOS | GpsCtrl::VEL;
}
...
{
	_ekf_params->gps_ctrl |= GpsCtrl::YAW;
}
